...
The module contains 35 popular color schemes in base16 format.
Some themes may contain modifications and differ from the official palette
Color schemes are packaged in a dictionary.
